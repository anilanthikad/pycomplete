...
<li class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
    <article class="product_pod">        
            ...
            <h3><a href="catalogue/a-light-in-the-attic_1000/index.html" title="A 
            Light in the Attic">A Light in the ...</a></h3>
...
class ParsedItemLocators:
    ...
    as well as change it quickly if is now different.
    """
