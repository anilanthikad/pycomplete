...
def prompt_add_book():  # ask for book name and author
    ...
    database_db.add_book(name, author)


def list_books():  # show all the books in our list
    books = database_db.get_all_books()
    for book in books:
